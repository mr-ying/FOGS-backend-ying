...
public class CurrencyController {
    ...
    static final String entity = "/Currency";
    ...
    public ResponseEntity<PagedResources<Resource<Currency>>> filterCurrency(
            @QuerydslPredicate(root = Currency.class) Predicate predicate,
            Pageable pageable,
            PagedResourcesAssembler<Currency> assembler){
